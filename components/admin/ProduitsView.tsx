            ...
            {filteredProducts.map((p, index) => {
              ...
              return (
                <tr
                  ...
                  className={`border-t border-ink-200 transition ${isSelected ? 'bg-brand-50/60' : 'hover:bg-ink-100'} ${pending ? 'opacity-60' : ''} ${draggedIndex === index ? 'opacity-40 bg-brand-50' : ''} ${dragOverIndex === index && draggedIndex !== index ? 'border-t-2 border-t-brand-500' : ''}`}
                >
                  {dragEnabled && (
